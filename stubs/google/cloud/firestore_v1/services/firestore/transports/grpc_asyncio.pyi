...
class FirestoreGrpcAsyncIOTransport(FirestoreTransport):
    ...
    @property
    def get_document(self) -> Callable[[firestore.GetDocumentRequest], Awaitable[document.Document]]: ...
    @property
    def list_documents(self) -> Callable[[firestore.ListDocumentsRequest], Awaitable[firestore.ListDocumentsResponse]]: ...
    @property
    def update_document(self) -> Callable[[firestore.UpdateDocumentRequest], Awaitable[gf_document.Document]]: ...
    @property
    def delete_document(self) -> Callable[[firestore.DeleteDocumentRequest], Awaitable[empty_pb2.Empty]]: ...
    @property
    def batch_get_documents(self) -> Callable[[firestore.BatchGetDocumentsRequest], Awaitable[firestore.BatchGetDocumentsResponse]]: ...
    @property
    def begin_transaction(self) -> Callable[[firestore.BeginTransactionRequest], Awaitable[firestore.BeginTransactionResponse]]: ...
    @property
    def commit(self) -> Callable[[firestore.CommitRequest], Awaitable[firestore.CommitResponse]]: ...
    @property
    def rollback(self) -> Callable[[firestore.RollbackRequest], Awaitable[empty_pb2.Empty]]: ...
    @property
    def run_query(self) -> Callable[[firestore.RunQueryRequest], Awaitable[firestore.RunQueryResponse]]: ...
    @property
    def run_aggregation_query(self) -> Callable[[firestore.RunAggregationQueryRequest], Awaitable[firestore.RunAggregationQueryResponse]]: ...
    @property
    def partition_query(self) -> Callable[[firestore.PartitionQueryRequest], Awaitable[firestore.PartitionQueryResponse]]: ...
    @property
    def write(self) -> Callable[[firestore.WriteRequest], Awaitable[firestore.WriteResponse]]: ...
    @property
    def listen(self) -> Callable[[firestore.ListenRequest], Awaitable[firestore.ListenResponse]]: ...
    @property
    def list_collection_ids(self) -> Callable[[firestore.ListCollectionIdsRequest], Awaitable[firestore.ListCollectionIdsResponse]]: ...
    @property
    def batch_write(self) -> Callable[[firestore.BatchWriteRequest], Awaitable[firestore.BatchWriteResponse]]: ...
    @property
    def create_document(self) -> Callable[[firestore.CreateDocumentRequest], Awaitable[document.Document]]: ...
    def close(self): ...
    @property
